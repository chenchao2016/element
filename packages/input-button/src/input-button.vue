<template>
    <div class="el-input-button" v-clickoutside="close">
        <el-input
                ref="input"
                v-bind="$props"
...
<script>
    ...
    import ElInputbuttonSuggestions from './inputbutton-suggestions.vue';
    ...
    export default {
        ...
        componentName: 'ElInputButton',

        components: {
            ElInput,
            ElButton,
            ElInputbuttonSuggestions
        },
